...
class TestBot(SingleServerIRCBot):
    ...
    def on_join(self, c, e):
        auteur = nm_to_n(e.source())
        canal = e.target()
        
        if auteur == self.nickname:
            c.privmsg(canal, "It's been a long time. How have you been?")
        else:
            c.privmsg(canal, "Oh... It's you " + auteur + ". Continue testing !")
